#!/usr/bin/env bash
# Move voice-to-text recordings older than 30 days from the hot directory
...
#
# Transcripts already live in SQLite (voice-to-text.db); the wav files
...
ROOT="$HOME/Library/Application Support/Voice-to-Text/recordings"
